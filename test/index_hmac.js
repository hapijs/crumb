...
describe('Crumb', () => {
        ...
        await server.register([
            Vision,
            {
                ...
                options: {
                    ...
                    method: 'hmac',
                    secret: 'SuperSecretKey_do_not_share!!!',
                    sessionKey: 'userId'
                }
            }
        ]);
    ...
    it('route should still validate crumb when autoGenerate is false and route.options.plugins.crumb is not defined', async () => {
        ...
        const crumbValue = Hmac.encrypt('john','SuperSecretKey_do_not_share!!!' );
    ...
    it('should fails validation when crumb has been forged', async () => {
        ...
        const headers = {
            'X-CSRF-Token': 'ThisIsAForgedToken_1607110465663'
        };
